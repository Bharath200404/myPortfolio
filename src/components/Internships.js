  ...
  const internships = [
    {
      ...
      points: [
        'Built an end-to-end handwritten equation recognition system using CNN and image processing techniques.',
        'Recognized handwritten digits and arithmetic operators from image inputs.',
        ' Developed an equation reconstruction and evaluation pipeline for real-time expression solving.',
      ],
    ...
    },
    {
      ...
      points: [
        'Developed a Restaurant Data Analysis project to transform raw Zomato data into structured analytical insights.',
        'Performed data cleaning, preprocessing, and exploratory analysis to identify trends in ratings, pricing and customer preferences.',
        'Analyzed restaurant popularity, service features, and location-wise distribution using visualization and SQL-based querying.',
      ],
